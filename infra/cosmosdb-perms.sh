...
az cosmosdb sql role assignment create --account-name cdb-conversational --resource-group rg-ConversationCopilot --principal-id 310310b5-d51d-4708-ae7a-082f9489b44f --role-definition-id "00000000-0000-0000-0000-000000000001" --scope "/subscriptions/28d10200-70b0-476c-b004-c6ae29265897/resourceGroups/rg-ConversationCopilot/providers/Microsoft.DocumentDB/databaseAccounts/cdb-conversational"
